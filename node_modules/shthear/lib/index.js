...
function ytmg(link){
    ...
    .then(({ data }) => {
        ...
        let titulo = $('div.thumbnail.cover > div > b').text();
        let video_mg = $('#mp4 > table > tbody > tr:nth-child(2) > td:nth-child(2)').text()
...
function ythd(link480){
    ...
    .then(({ data }) => {
        const $ = cheerio.load(data.result)
        let img = $('div.thumbnail.cover > a > img').attr('src');
        let titulo2 = $('div.thumbnail.cover > div > b').text();
