...
export declare type LocalFunc<T> = (previousAnswers?: ConfigMap) => T | Promise<T>;
export declare type DynamicValue<T> = Func | LocalFunc<T>;
 ...
 */
export declare type DymanicOption = DynamicValue<StaticOption>;
/**
...
export declare type Validation = NumberValidation | StringValidation | StringArrayValidation | FileValidation | RemoteFuncValidation | LocalFuncValidation;
/**
 * Basic question data
 */
...
export declare type Question = SingleSelectQuestion | MultiSelectQuestion | TextInputQuestion | NumberInputQuestion | FuncQuestion | LocalFuncQuestion | FileQuestion;
/**
