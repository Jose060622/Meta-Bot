 ...
 */
export declare class PluginTelemetryReporter implements TelemetryReporter {
    private readonly reporter;
    private readonly pluginName;
    constructor(reporter: TelemetryReporter, pluginName: string);
    sendTelemetryEvent(eventName: string, properties?: Record<string, string>, measurements?: {
        [p: string]: number;
    }): void;
    sendTelemetryErrorEvent(eventName: string, properties?: Record<string, string>, measurements?: {
        [p: string]: number;
    }, errorProps?: string[]): void;
    sendTelemetryException(error: Error, properties?: Record<string, string>, measurements?: {
        [p: string]: number;
    }): void;
    private addPluginProps;
    private pluginify;
}
